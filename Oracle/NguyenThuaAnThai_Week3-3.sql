...
UPDATE JOB_HISTORY SET END_DATE = to_date('13-JAN-01','DD-MON-RR') WHERE EMPLOYEE_ID = 102;
-- BAI 4
...
UPDATE EMPLOYEES SET SALARY = 24200 WHERE EMPLOYEE_ID =100;
UPDATE EMPLOYEES SET COMMISSION_PCT = 0.01 WHERE EMPLOYEE_ID =145;